...
final class SpyMemcachedBinaryTestStandalone extends SpyMemcachedBaseTest {
  ...
  private MemcacheService gaeMemcacheClient = MemcacheServiceFactory.getMemcacheService();
  ...
  private void testAdd() throws Exception {
    ...
    expectTrue(client.get(key).equals(gaeMemcacheClient.get(key)), "testAdd transcoder");
  }
  ...
  private void testAppend() throws Exception {
    ...
    expectTrue(client.get(key).equals(gaeMemcacheClient.get(key)), "testAppend transcoder");
  }
  ...
  public void testGet() throws Exception {
    ...
    expectTrue(gaeMemcacheClient.get(key).equals("value1"), "testGet transcoder");
  }
  ...
  public void testIncr() throws Exception {
    ...
    expectTrue(gaeMemcacheClient.increment(key, 1) == 12, "testIncr transcoder");
  }
  ...
  public void testDecr() throws Exception {
    ...
    expectTrue(gaeMemcacheClient.increment(key, -1) == 8, "testDecr transcoder");
  }
  ...
  public void testPrepend() throws Exception {
    ...
    expectTrue(client.get(key).equals(gaeMemcacheClient.get(key)), "testPrepend transcoder");
  }
  ...
  public void testReplace() throws Exception {
    ...
    expectTrue(client.get(key).equals(gaeMemcacheClient.get(key)), "testReplace transcoder");
  }
  ...
  public void testSet() throws Exception {
    ...
    gaeMemcacheClient.put(key, value);
    expectTrue(client.get(key).equals(gaeMemcacheClient.get(key)), "testSet transcoder");
  }
